...
!(function (root) {
  ...
  Text.prototype.text = function (obj) {
    ...
    if (helper) {
      this.helperDiv.css("background", "rgba(0,0,0,0.2)").text(helper + "供稿");
    } else {
      this.helperDiv.css("background", "rgba(0,0,0,0)").text("");
    }
  };
  ...
  Text.prototype.div = function () {
    var textDiv = (this.textDiv = $("<div></div>")
